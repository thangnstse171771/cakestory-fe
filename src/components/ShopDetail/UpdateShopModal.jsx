...
function UpdateShopModal({ open, onClose, shop, userId, onUpdated }) {
  ...
  // Parse existing address to get province, ward, and detail address
  const parseAddress = (fullAddress) => {
    if (!fullAddress) return { province: "", ward: "", detail_address: "" };
    ...
    if (parts.length >= 3) {
      return {
        ...
        detail_address: parts.slice(0, -2).join(", "),
      };
    }
    return { province: "", ward: "", detail_address: fullAddress };
  };

  const addressParts = parseAddress(
    shop.business_address || shop.location || ""
  );
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl border border-pink-100 overflow-hidden w-full max-w-6xl max-h-[95vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between px-8 py-6 border-b border-pink-100 bg-gradient-to-r from-pink-50 to-purple-50">
          <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600">
            Cập nhật thông tin Shop
          </h2>
          <button
            className="text-gray-400 hover:text-pink-500 text-3xl font-bold transition-colors"
            onClick={onClose}
            title="Đóng"
          >
            ×
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="text-white">
                  <h3 className="text-xl font-bold">
                    {shop.name || shop.business_name || "Preview Shop"}
                  </h3>
        ...
        <Formik
          initialValues={{
            business_name: shop.name || shop.business_name || "",
            province: addressParts.province || "",
            ward: addressParts.ward || "",
            detail_address: addressParts.detail_address || "",
          ...
          onSubmit={async (values, { setSubmitting }) => {
            ...
            try {
              ...
              if (avatarFile) {
                avatarUrl = await uploadShopImage(avatarFile, userId, "avatar");
              }
              ...
              const errorMessage =
                "Không thể cập nhật cửa hàng. Vui lòng thử lại.";
            ...
            <Form className="p-8 space-y-8">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (file) {
                          ...
                          setBackgroundPreview(shop.background_image || "");
                        }
                      }}
              ...
              <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl p-6 border border-yellow-200">
                ...
                <div className="text-gray-500 text-sm mt-2">
                  💡 Hãy viết một đoạn giới thiệu thu hút để khách hàng hiểu rõ
                  về shop của bạn
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-500 text-sm mt-4">
                  Thông tin đã được cập nhật sẽ hiển thị ngay lập tức
                </p>
              </div>
            </Form>
          )}
