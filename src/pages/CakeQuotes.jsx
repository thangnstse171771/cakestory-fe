                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center p-3 bg-white rounded-xl">
                          ...
                          <span className="font-bold text-gray-900 px-3 py-1 bg-pink-100 text-pink-700 rounded-lg">
                            {cakeQuote.cake_size}
                          </span>
                        </div>
                        <div className="flex justify-between items-center p-3 bg-white rounded-xl">
                          ...
                          <div className="flex items-start gap-6">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                ...
                                <div className="bg-gradient-to-br from-blue-50 to-pink-50 p-4 rounded-xl border border-blue-200">
                              ...
                              {quote.ingredients && (
                                <div className="bg-gradient-to-r from-rose-50 to-pink-50 p-4 rounded-xl mb-6 border border-rose-200">
                                  <h6 className="text-sm font-bold text-rose-800 mb-2 flex items-center gap-2">
                              ...
                              <div className="flex gap-3">
                                ...
                                {quote.status === "accepted" && (
                                  <button
                                    ...
                                    className="px-6 py-3 bg-gradient-to-r from-blue-500 to-pink-600 text-white rounded-xl font-bold hover:from-blue-600 hover:to-pink-700 transition-all duration-200 shadow-lg hover:shadow-xl"
                                  >
                                    Đặt hàng
                                  </button>
                                )}
          ...
          <div className="mt-12 mb-8">
            ...
            <div className="flex justify-center items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 rounded-xl border border-pink-200 text-pink-600 hover:bg-pink-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium"
              >
