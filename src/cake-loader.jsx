        ...
        <div className="relative">
          ...
          <div className="relative mx-auto mb-8">
            <div className="relative h-48 w-48">
              {/* Cupcake wrapper */}
              <div className="absolute bottom-0 left-1/2 h-24 w-32 -translate-x-1/2 transform rounded-b-3xl bg-gradient-to-b from-amber-200 to-amber-400 shadow-lg">
              ...
              {/* Cake base */}
              <div className="absolute bottom-6 left-1/2 h-20 w-28 -translate-x-1/2 transform rounded-t-full bg-gradient-to-b from-yellow-300 to-orange-400 shadow-md">
              ...
              {/* Cream container */}
              <div className="absolute top-0 left-1/2 h-32 w-24 -translate-x-1/2 transform overflow-hidden">
              ...
              {progress > 30 && (
                <>
                  ...
                  <motion.div
                    className="absolute top-8 right-6 text-pink-400"
                    animate={{
                      rotate: -360,
                      scale: [1, 1.3, 1],
                    }}
                  ...
                  <motion.div
                    className="absolute top-12 left-4 text-purple-400"
                    animate={{
                      rotate: 360,
                      scale: [1, 1.1, 1],
                    }}
          ...
          {/* Progress bar */}
          <div className="mx-auto w-64 h-3 bg-gray-200 rounded-full overflow-hidden shadow-inner">
            <motion.div
